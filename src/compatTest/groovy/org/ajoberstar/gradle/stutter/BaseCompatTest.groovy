...
"""
    ...
    if (Runtime.metaClass.respondsTo(Runtime, 'version')) {
      compatTestTasks = [':compatTest4.0.2', ':compatTest4.1', ':compatTest4.2.1']
    } else {
      compatTestTasks = [':compatTest3.0', ':compatTest3.1', ':compatTest3.2.1', ':compatTest3.3', ':compatTest3.4.1', ':compatTest3.5.1']
    }
  }
